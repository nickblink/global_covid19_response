...
CAR_list = CARBayes_imputation(df_miss, col = "y", return_type = 'all', burnin = 5000, n.sample = 10000)
df_miss = CAR_list$facility_df

county_miss = merge(periodic_list$county_fit, CAR_list$county_df, by = 'date')

#HERE on 05042021 - figure out the PIs for COUNTY-LEVEL Bayes! What to do, what to do
...
p2 <- plot_county_fits(df_miss, imp_vec, color_vec)
